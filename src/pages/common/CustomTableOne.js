...
import icon01 from '../../assets/img/custom/pendingOrdersTable/icon01.svg';
import icon02 from '../../assets/img/custom/pendingOrdersTable/icon02.svg';
import icon03 from '../../assets/img/custom/pendingOrdersTable/icon03.svg';

// eslint-disable-next-line react/prop-types
const CustomTableOne = ({ isFluid }) => {
						...
						<div className='d-flex'>
							<div
								...
								<img
									...
									alt=''
								/>{' '}
								3 Preparing orders and
								<img
									style={{ marginLeft: '3px', marginRight: '3px' }}
									src={icon03}
									alt=''
								/>{' '}
								4 pending orders for now.
							</div>
